...
class salas_model(models.Model):
    ...
    name = fields.Char(String="Nº de sala",index=True,required=True)
    cantidad_butacas_totales = fields.Integer(String="Cantidad de butacas totales de la sala",required=True)
